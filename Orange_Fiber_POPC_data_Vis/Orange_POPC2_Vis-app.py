...
Gmina_All = ['Jaktorów', 'Grodzisk Mazowiecki', 'Brwinów']
Gmina = st.sidebar.selectbox('Gmina: ', Gmina_All)
st.sidebar.text('Made by SamoX')
# st.sidebar.slider('Do momentu w czasie', ['29-11-2020', '2-12-2020'])
print(Gmina)

jaktorow_geo = [52.079488, 20.551613]
# grodzisk_geo = [52.103698, 20.623369]
# brwinow_geo = [52.142222, 20.719591]

# polaczenie = {}
# polaczenie['Jaktorów'] = jaktorow_geo
# polaczenie['Grodzisk Mazowiecki'] = grodzisk_geo
# polaczenie['Brwinów'] = brwinow_geo
