...
### Wykres kolowy rozkladu klas
# plt.figure(figsize= (10,10))
# my_circle = plt.Circle((0,0), 0.7, color = 'white') 
# plt.pie(train_raw[187].value_counts(), 
#         labels=['Normal Beats','Unknown Beats', 'Ventricular ectopic beats',
...
# >> 4) Add (Residual Skip) - Dodanie start petli + po kroku 3)
# >> 5) ReLU
...
history = model.fit(X_train, Y_train, epochs = 5, callbacks=callbacks_list, validation_data=(X_test, Y_test))
