...
str(dane_wilo)
#podzia na zbi?r testowy i treningowy klacyfinacja binarna
...
#podzia na zbi?r testowy i treningowy regresja
...
#podzia na zbi?r testowy i treningowy klasyfikacja welokalsowa
...
#2) Rozwi?zuj? Pa?stwo 3 powy?sze problemy wykorzystuj?c opracowane algorytmy:
  #   a) Dla klasyfikacji binarnej: k-najbli?szych s?siad?w, drzewa decyzyjne, sieci neuronowe.
  #   b) Dla klasyfikacji wieloklasowej: k-najbli?szych s?siad?w, drzewa decyzyjne, sieci neuronowe.
#     c) Dla regresji: k-najbli?szych s?siad?w, drzewa decyzyjne, sieci neuronowe.
  # 

#   
#k-najbli?szych s?siad?w regresja
KNN_train_reg<-KNN_train( dane_reg_train[,-7],dane_reg_train[,7], k = 5,1,100)
KNN_pred(KNN_train_reg,dane_reg_test[,-7])
#k-najbli?szych s?siad?w klasyfikacja wiloklasowa
KNN_train_wielo<-KNN_train( dane_wielo_train[,-5],dane_wielo_train[,5], k = 5,1,100)
KNN_pred(KNN_train_wielo,dane_wielo_test[,-5])
#k-najbli?szych s?siad?w klasyfikacja binarna
...
#3) Por?wnuj? Pa?stwo wyniki otrzymane dla w?asnych algorymt?w z wynikami otrzymanymi dla algorytm?w pochodz?cych z innych 
#    pakiet?w w R, np: caret, rpart, nnet, neuralnet.
...
#k-najbli?szych s?siad?w klasyfikacja wielkoasowa
