...
#   c) regresja.
#   Na tę chwilę każdy z Państwa otrzyma jeden zbiór danych (albo do klasyfikacji binarnej albo wieloklasowej). 
...
#   a) Dla klasyfikacji binarnej: k-najbliższych sąsiadów, drzewa decyzyjne, maszynę wektorów nośnych.
#   b) Dla klasyfikacji wieloklasowej: k-najbliższych sąsiadów, drzewa decyzyjne.
#   c) Dla regresji: k-najbliższych sąsiadów, drzewa decyzyjne, maszynę wektorów nośnych.
# 
...
# 
# 6) Projekty proszę przesłać do 12 lutego do godziny 23.59.
