...
R_GRID_TREE_klasyfikacja_binarna = expand.grid(maxdepth=2:8)
R_CV_TREE_binarna = train(x=data_klasyfikacja_binarna[,data_klasyfikacja_binarna_X], y=data_klasyfikacja_binarna[,data_klasyfikacja_binarna_Y], tuneGrid=R_GRID_TREE_klasyfikacja_binarna, method='rpart2', metric='Accuracy', trControl=kroswalidacja_train)
...
R_CV_TREE_wieloklasowa = train(x=data_klasyfikacja_wieloklasowa[,data_klasyfikacja_wieloklasowa_X], y=data_klasyfikacja_wieloklasowa[,data_klasyfikacja_wieloklasowa_Y], tuneGrid=R_GRID_TREE_wieloklasowa, method='rpart2', metric='Accuracy', trControl=kroswalidacja_train)
...
R_CV_TREE_regresja = train(x=data_regresja[,data_regresja_X], y=data_regresja[,data_regresja_Y], tuneGrid=R_GRID_TREE_regresja, method='rpart2', metric='MAE', trControl=kroswalidacja_train)
...
Kroswalidacja_NN_klasyfikacja_binarna_TABELA[is.na(Kroswalidacja_NN_klasyfikacja_binarna_TABELA)] <- 0.0
Kroswalidacja_NN_klasyfikacja_binarna_TABELA$h <- as.character(Kroswalidacja_NN_klasyfikacja_binarna_TABELA$h)
Kroswalidacja_NN_klasyfikacja_binarna_TABELA$h <- str_remove(Kroswalidacja_NN_klasyfikacja_binarna_TABELA$h, pattern = "c")
Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana <- as.data.frame(Kroswalidacja_NN_klasyfikacja_binarna_TABELA %>% group_by( h, lr, iter) %>% summarise(AUCT = mean(AUCT), CzuloscT = mean(CzuloscT), SpecyficznoscT = mean(SpecyficznoscT), JakoscT = mean(JakoscT),AUCW = mean(AUCW), CzuloscW = mean(CzuloscW), SpecyficznoscW = mean(SpecyficznoscW), JakoscW = mean(JakoscW), ))
print(Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana)

plot(x = 1:nrow(Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana), y = Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana[,"JakoscT"], type = 'b', col='red', xlab = "Model (nr z tabeli)", ylab = "Dokladnosc", ylim = c(0.32, 0.75))
lines(x = 1:nrow(Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana), y = Kroswalidacja_NN_klasyfikacja_binarna_TABELA_grupowana[,"JakoscW"], type = 'b', col='blue')
legend("topleft", legend=c("Dokladnosc Trening", "Dokladnosc Walidacja"), col=c("red", "blue"), lty = 1:2, cex=0.8)
...
Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA[is.na(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA)] <- 0.0
Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA$h <- as.character(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA$h)
Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA$h <- str_remove(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA$h, pattern = "c")
Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana <- as.data.frame(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA %>% group_by( h, lr, iter) %>% summarise(ACCT = mean(ACCT), ACCW = mean(ACCW)))
print(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana)

plot(x = 1:nrow(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana), y = Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana[,"ACCT"], type = 'b', col='red', xlab = "Model (nr z tabeli)", ylab = "Dokladnosc", ylim = c(0.68,0.72))
lines(x = 1:nrow(Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana), y = Kroswalidacja_NN_klasyfikacja_wieloklasowa_TABELA_grupowana[,"ACCW"], type = 'b', col='blue')
legend("topleft", legend=c("Dokladnosc Trening", "Dokladnosc Walidacja"), col=c("red", "blue"), lty = 1:2, cex=0.8)
...
Kroswalidacja_NN_regresja_TABELA[is.na(Kroswalidacja_NN_regresja_TABELA)] <- 0.0
Kroswalidacja_NN_regresja_TABELA$h <- as.character(Kroswalidacja_NN_regresja_TABELA$h)
Kroswalidacja_NN_regresja_TABELA$h <- str_remove(Kroswalidacja_NN_regresja_TABELA$h, pattern = "c")
Kroswalidacja_NN_regresja_TABELA_grupowana <- as.data.frame(Kroswalidacja_NN_regresja_TABELA %>% group_by( h, lr, iter) %>% summarise(MAET = mean(MAET), MSET = mean(MSET), MAPET = mean(MAPET), MAEW = mean(MAEW), MSEW = mean(MSEW), MAPEW = mean(MAPEW)))
print(Kroswalidacja_NN_regresja_TABELA_grupowana)

plot(x = 1:nrow(Kroswalidacja_NN_regresja_TABELA_grupowana), y = Kroswalidacja_NN_regresja_TABELA_grupowana[,"MAET"], type = 'b', col='red', xlab = "Model (nr z tabeli)", ylab = "MAE", ylim = c(0.3, 0.52))
lines(x = 1:nrow(Kroswalidacja_NN_regresja_TABELA_grupowana), y = Kroswalidacja_NN_regresja_TABELA_grupowana[,"MAEW"], type = 'b', col='blue')
legend("topleft", legend=c("MAE Trening", "MAE Walidacja"), col=c("red", "blue"), lty = 1:2, cex=0.8)


data_regresja_norm <- data.frame(sapply(data_regresja, MinMax))
summary(data_regresja_norm)
NN_regresja_przyklad <- trainNN(x = as.matrix(data_regresja_norm[,data_regresja_X]), y_tar = as.matrix(data_regresja_norm[,data_regresja_Y]), h = c(5,7), lr = 0.01, iter = 20000, seed = 614, typ = 'reg')
...
R_CV_NN_binarna = train(x=data_klasyfikacja_binarna_norm, y=data_klasyfikacja_binarna[,data_klasyfikacja_binarna_Y], tuneGrid=R_GRID_NN_binarna, method='nnet', metric='Accuracy', trControl=kroswalidacja_train)
...
R_CV_NN_wieloklasowa = train(x=data_klasyfikacja_wieloklasowa_norm, y=data_klasyfikacja_wieloklasowa[,data_klasyfikacja_wieloklasowa_Y], tuneGrid=R_GRID_NN_wieloklasowa, method='nnet', metric='Accuracy', trControl=kroswalidacja_train)
...
R_CV_NN_regresja = train(x=data_regresja_norm[,data_regresja_X], y=data_regresja_norm[,data_regresja_Y], tuneGrid=R_GRID_NN_regresja, method='nnet', metric='MAE', trControl=kroswalidacja_train)
